...
if py2 is not None:
    ...
    if but:
        # Verifica se o ambiente tem uma interface gráfica disponível
        if 'DISPLAY' in os.environ:
            ...
            st.error("Este script requer um ambiente gráfico para ser executado. Por favor, execute-o em um ambiente com suporte gráfico.")
